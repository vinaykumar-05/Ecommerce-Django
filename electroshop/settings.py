...
SECRET_KEY = 'django-insecure-hzwr3qnoy=xc*ax=o38uf012vt-dli=6@rjb)pty10!h9&!a%g'
...
EMAIL_HOST_PASSWORD = 'isri svkb esbl ogif'
...
MESSAGE_TAGS = {
    messages.ERROR: 'danger',  # So error messages use Bootstrap 'alert-danger'
